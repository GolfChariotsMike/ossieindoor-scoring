...
export const TeamScore = ({ teamName, score, onScoreUpdate }: TeamScoreProps) => {
  ...
  return (
    <div className="text-center flex flex-col items-center">
      <div className={`font-display text-volleyball-cream uppercase tracking-[0.2em] mb-4 w-[400px] h-24 flex items-center justify-center [text-shadow:_2px_2px_0_rgb(0_0_0)] ${getTextSizeClass(teamName)}`}>
        {teamName}
      </div>
      <button
        className={`w-[450px] aspect-square text-[18rem] ${isLongPress ? 'bg-volleyball-black/70' : 'bg-volleyball-black'} 
        text-volleyball-cream font-score rounded-3xl mb-4 select-none touch-none transition-colors`}
